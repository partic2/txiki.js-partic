...
class DatagramEndpoint {
    ...
    setMembership(multicast_addr, interface_addr, join) {
        return this[kHandle].setMembership(multicast_addr, interface_addr, join);
    }

    setBroadcast(enable) {
        return this[kHandle].setBroadcast(enable);
    }
